...
function bang(){
    ...
    tp1.innerHTML = 'কম্পিউটার প্রোগ্রামিং হল একটি নির্দিষ্ট কম্পিউটিং ফলাফল সম্পাদন করতে বা একটি নির্দিষ্ট কার্য সম্পাদন করার জন্য এক্সিকিউটেবল কম্পিউটার প্রোগ্রামের নকশা এবং তা তৈরী করা প্রক্রিয়া।';
